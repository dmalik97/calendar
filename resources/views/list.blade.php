...
@section('content')
   ...
   <div class="panel panel-primary">
          <div class="panel-heading text-right">
            <button id="create_event"  type="button" class="btn btn-success btn-md"><i class="fa fa-plus"></i>  Dodaj wydarzenie</button>
          </div>
           ...
           <div class="modal-dialog" >                           
            <div class="modal-content admin-form">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Pokaż wydarzenie</h4>
                </div> 
                <div class="modal-body">
                  ...
                  <div class="section row">
                    ...
                    <div class="col-md-12">
                        ...
                        <label class="">Opis wydarzenia</label>
                         <label for="" class="field">
                ...
                <form id="create_event_frm"  action="{{route('event')}}"  method="post" enctype="multipart/form-data"  >
                  ...
                  <div class="row">
                    <div class="pull-left" style="width: 75%;">
                      <div class="col-lg-5 col-xs-12">
                        <div class="form-group">
                          <input type="text"   name="event_start_date" required="" id="event_start_date" value="" class="form-control date_pick" placeholder="Data początkowa">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-5 col-xs-12" id="event_start_time_area" style="display: none">
                        <!--                                 none-->
                        <div class="form-group">
                          <input type="text"   name="event_start_time" id="event_start_time" value="12:00 AM" class="form-control time_pick" placeholder="Czas początkowy">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="section row" id="end_date_area" style="display: none">
                    ...
                    <div class="pull-left" style="width: 75%;">
                      <div class="col-lg-5 col-xs-12">
                        <div class="form-group">
                          <input type="text"   name="event_end_date" id="event_end_date" value="" class="form-control date_pick" placeholder="Data końcowa">
                        </div>
                      </div>
                      <div class="col-lg-2 col-xs-2">
                      ...
                      <div class="col-lg-5 col-xs-12" id="event_end_time_area" style="display: none">
                        <!--                    //none-->
                        <input type="text"   name="event_end_time" id="event_end_time" value="11:59 PM" class="form-control time_pick" placeholder="Czas końcowy">
                      </div>
                    </div>
                    <div class="pull-right">
                      <div class="col-lg-2 col-xs-2">
                  ...
                  <div class="section row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea class="form-control" id="event_description" name="event_description" placeholder="Opis wydarzenia" ></textarea>
                      </div>
                    </div>
                  </div>
                ...
                <form id="edit_event_frm" action=""  method="post" enctype="multipart/form-data"  >
                  ...
                  <div class="row">
                    <div class="pull-left" style="width: 75%;">
                      <div class="col-lg-5 col-xs-12">
                        <div class="form-group">
                          <label class="">Data początkowa</label>
                          <input type="text"   name="event_start_date" required="" id="edit_event_start_date" value="" class="form-control date_pick" placeholder="Data początkowa">
                        </div>
                      </div>
                      <div class="col-lg-2 col-xs-2">
                      ...
                      <div class="col-lg-5 col-xs-12" id="edit_event_start_time_area" style="display: block">
                        <div class="form-group">
                          <label class="">Czas początkowy</label>
                          <input type="text"   name="event_start_time" id="edit_event_start_time" value="" class="form-control time_pick" placeholder="Czas początkowy">
                        </div>
                      </div>
                    </div>
                    <div class="pull-right" >
                  ...
                  <div class="row" id="edit_end_date_area" style="display: block">
                    <div class="pull-left" style="width: 75%;">
                      <div class="col-lg-5 col-xs-12">
                        <div class="form-group">
                          <label class="">Data końcowa</label>
                          <input type="text"   name="event_end_date" id="edit_event_end_date" value="" class="form-control date_pick" placeholder="Data końcowa">
                        </div>
                      </div>
                      <div class="col-lg-2 col-xs-2">
                      ...
                      <div class="col-lg-5 col-xs-12" id="edit_event_end_time_area" style="display: block">
                        <div class="form-group">
                          <label class="">Czas końcowy</label>
                          <input type="text"   name="event_end_time" id="edit_event_end_time" value="" class="form-control time_pick" placeholder="Czas końcowy">
                        </div>
                      </div>
                    </div>
                    <div class="pull-right">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="">Opis wydarzenia</label>
                        <textarea class="form-control" id="edit_event_description" name="event_description" placeholder="Opis wydarzenia" ></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="section" style="margin-top: 10px">
                    <p class="text-right">
                      <button type="button" id="edit_event_btn"  class="btn btn-primary">Zaktualizuj</button>
                    </p>
                  </div>
                  <!-- end section row -->
                </form>
...
var loader='<img class="loader" src="<?php echo asset('image/ajax-loader.gif')?>"/>';
