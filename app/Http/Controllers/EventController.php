...
class EventController extends Controller
{
    ...
    public function save_event(Request $request)
    {
      $this->event_list();
        ...
        if ($validator->passes()){
         ...
         $feed_back['message']='Dodano nowe wydarzenie';
    ...
    public function update_event(Request $request){
        ...
        if ($validator->passes()){
         ...
         $feed_back['type']='alert-success';
         $feed_back['message']='Wydarzenie zaktualizowane';
         $feed_back['error']=array();    
    ...
    public function delete_event($id){
         $feed_back['type']='alert-danger';
          $feed_back['message']=  'Coś poszło nie tak';
      ...
      $event->delete();
    $feed_back['type']='alert-success';
         $feed_back['message']='Wydarzenie usunięte';
